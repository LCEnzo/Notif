...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(controller.settings.toDartSnippet(), contains('spacing: 3.5,'));
  ...
  testWidgets(
    'PageBackground exposes the debug tuner and updates the controller',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(body: PageBackground(child: SizedBox.expand())),
        ),
      );
      ...
      final sliderFinder = find.byKey(
        const Key('authTextureField-grainSpacing'),
      );
  ...
  testWidgets(
    'Texture settings persist between login and register in one session',
    (WidgetTester tester) async {
      final controller = enableAuthTextureTuner();
      ...
      final loginSliderFinder = find.byKey(
        const Key('authTextureField-grainSpacing'),
      );
