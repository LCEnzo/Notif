...
# the dev API — and when DEV_BOOTSTRAP_LOGIN_ENABLED is on it is a login with a
# password committed to the repo, so that page could log itself in as the dev user.
